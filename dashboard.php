...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center p-6">
  ...
  <div class="grid gap-6 lg:grid-cols-2 w-full max-w-6xl">
    ...
    <!-- Card Besar: Pengumuman -->
    <div
      class="bg-orange-100 dark:bg-orange-900 rounded-2xl shadow-lg p-6 flex flex-col items-center justify-center text-center hover:scale-105 transition">
